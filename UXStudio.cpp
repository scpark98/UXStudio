...
// UXStudio.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CUXStudioApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CUXStudioApp::OnAppAbout)
...
CUXStudioApp::CUXStudioApp() noexcept
{
	...
	SetAppID(_T("UXStudio.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CUXStudioApp 개체입니다.
...
BOOL CUXStudioApp::InitInstance()
{
	...
	//CoInitializeEx()를 호출하지 않아도 정상 동작한다?
	...
	pDocTemplate = new CMultiDocTemplate(IDR_UXStudioTYPE,
		RUNTIME_CLASS(CUXStudioDoc),
		RUNTIME_CLASS(CChildFrame), // 사용자 지정 MDI 자식 프레임입니다.
		RUNTIME_CLASS(CUXStudioView));
	if (!pDocTemplate)
		return FALSE;
...
void CUXStudioApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CUXStudioApp 사용자 지정 로드/저장 방법

void CUXStudioApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CUXStudioApp::LoadCustomState()
{
}

void CUXStudioApp::SaveCustomState()
{
}
